...
#read the freq. of introgression
...
#$f1="basic_popGen_statistic/outPopGen_emmerWVSemmerD"; #this file has the statistic for emmerW and emmerD
$f1="basic_popGen_statistic/outPopGen_wheatVSemmerW";
