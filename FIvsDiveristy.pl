...
#open MM,"tmpdir/pi/aa.out_south1.windowed.pi" or die "l";
#open MM,"tmpdir/pi/aa.out_emmerD.windowed.pi" or die "l";
#open MM,"tmpdir/pi/aa.out_landraceWheatAcc308.windowed.pi" or die "l";

#pi was caluclated by VCFtools for each SNP site
open MM,"tmpdir/pi/aa.out1_landraceWheatAcc308.sites.pi" or die "l";
#open MM,"tmpdir/pi/aa.out1_emmerD.sites.pi" or die "l";
#open MM,"tmpdir/pi/aa.out1_south1.sites.pi" or die "l";
...
while(<MM>){
	...
	$tem[4]=$tem[2];
	$tem[4]=$tem[4]*10000000;

	$tem[2]=$tem[1]+1;
	print NN "$tem[0]\t$tem[1]\t$tem[2]\t$tem[0]:$tem[1]\t$tem[4]\n"; 
}
close MM;
close NN;
...
`awk '{print \$1"\t"\$2/10000000}' tmpdir/res > tmpdir/res1`;


`awk '{print \$2/10000000"\t"\$1}' tmpdir/res > tmpdir/res2`;
